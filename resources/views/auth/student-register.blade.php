<x-layout documentTitle="Student Register">
    <h1 class="mt-5 pt-4">Registrazione Corsista</h1>
    <div class="container">
                ...
                <form method="POST" action="{{ route('register.student') }}">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="M" id="radioMaschio"
                                name="gender">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="F" id="radioFemmina"
                                name="gender">
