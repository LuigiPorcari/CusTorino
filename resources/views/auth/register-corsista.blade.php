        ...
        <div class="row justify-content-center mt-4">
            <div class="col-12 col-md-8">
                <div class="card custom-card">
                    <div class="card-header custom-card-header fs-4">Registrati come Corsista</div>
                    <div class="card-body custom-card-body">
                        <form method="POST" action="{{ route('corsista.register') }}">
                            @csrf
                            <!-- Nome -->
                            <div class="form-group mb-3">
                                <label class="custom-form-label" for="name">Nome</label>
                                <input id="name" type="text" class="custom-form-input @error('name') is-invalid @enderror"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select id="genere" class="custom-form-input @error('genere') is-invalid @enderror" name="genere"
                                    required>
