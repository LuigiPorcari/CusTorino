<x-layout documentTitle="Student Register">
    <main>
        <h1 class="visually-hidden">Registrazione Corsista - Beach Volley Custorino</h1>

        <div class="container mt-5 pt-5">
            <div class="row justify-content-center mt-4">
                <div class="col-12 col-md-8">
                    <div class="card custom-card">
                        <div class="card-header custom-card-header fs-4" id="student-register-title">Registrati come Corsista</div>
                        <div class="card-body custom-card-body">
                            <form method="POST" action="{{ route('corsista.register') }}" aria-labelledby="student-register-title">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-group mb-0">
                                                <button type="submit" class="btn custom-btn-submit" aria-label="Conferma registrazione corsista">
                                                    Registrati
                                                </button>
                                            </div>
                                        </div>
