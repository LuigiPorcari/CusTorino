<x-layout documentTitle="Homepage">
    <div class="container-fluid mt-5 text-center p-5">
        <div class="row">
            <div class="col-12">
                <h1 class="mt-5 custom-title">Benvenuto nella Homepage</h1>
    ...
    <div class="container">
        ...
        <div class="row flex-column-reverse flex-md-row justify-content-center">
            <div
                class="me-2 col-12 col-md-5 border rounded-4 d-flex justify-content-center align-items-center flex-column text-center shadow custom-homepage-col">
            ...
            <div
                class="ms-2 col-12 col-md-5 border rounded-4 d-flex justify-content-center align-items-center flex-column text-center shadow custom-homepage-col mb-3">
        ...
        <div class="row flex-column flex-md-row justify-content-center mt-5">
            <div
                class="me-2 col-12 col-md-5 border rounded-4 d-flex justify-content-center align-items-center flex-column text-center shadow custom-homepage-col mb-3">
                <img src="{{ asset('img/rete.jpg') }}" alt="rete di pallavolo" class="img-fluid">
            </div>
            <div
                class="ms-2 col-12 col-md-5 border rounded-4 d-flex justify-content-center align-items-center flex-column text-center shadow custom-homepage-col">
