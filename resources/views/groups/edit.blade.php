<x-layout documentTitle="Modify Groups">
    ...
    <div class="container mt-5 pt-1">
        ...
        <div class="row justify-content-center">
            <div class="col-12 custom-card mb-5 p-4">
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="custom-form-input" id="giorno_settimana" name="giorno_settimana"
                                        required>
                                        <option @if ($group->giorno_settimana == 'lunedi') selected @endif value="lunedi">Lunedì
                                        </option>
                                        <option @if ($group->giorno_settimana == 'martedi') selected @endif value="martedi">
                                            Martedì</option>
                                        <option @if ($group->giorno_settimana == 'mercoledi') selected @endif value="mercoledi">
                                            Mercoledì</option>
                                        <option @if ($group->giorno_settimana == 'giovedi') selected @endif value="giovedi">
                                            Giovedì</option>
                                        <option @if ($group->giorno_settimana == 'venerdi') selected @endif value="venerdi">
                                            Venerdì</option>
                                        <option @if ($group->giorno_settimana == 'sabato') selected @endif value="sabato">Sabato
                                        </option>
                                        <option @if ($group->giorno_settimana == 'domenica') selected @endif value="domenica">
                                            Domenica</option>
                                    </select>
                                </div>
                                {{-- SEDE --}}
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="custom-form-input" id="orario" name="orario" required>
                                        <option @if ($group->orario == '13:00:00') selected @endif value="13:00">13:00
                                        </option>
                                        <option @if ($group->orario == '13:30:00') selected @endif value="13:30">13:30
                                        </option>
                                        <option @if ($group->orario == '14:00:00') selected @endif value="14:00">14:00
                                        </option>
                                        ...
                                        <option @if ($group->orario == '18:00:00') selected @endif value="18:00">18:00
                                        </option>
                                        <option @if ($group->orario == '18:30:00') selected @endif value="18:30">18:30
                                        </option>
                                        <option @if ($group->orario == '19:00:00') selected @endif value="19:00">19:00
                                        </option>
                                        <option @if ($group->orario == '19:30:00') selected @endif value="19:30">19:30
                                        </option>
                                        <option @if ($group->orario == '20:00:00') selected @endif value="20:00">20:00
                                        </option>
                                        <option @if ($group->orario == '20:30:00') selected @endif value="20:30">20:30
                                        </option>
                                        <option @if ($group->orario == '21:00:00') selected @endif value="21:00">21:00
                                        </option>
                                        <option @if ($group->orario == '21:30:00') selected @endif value="21:30">21:30
                                        </option>
                                    </select>
                                </div>
                                {{-- CAMPO --}}
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="custom-form-input" id="secondo_allenatore_id"
                                        ...
                                        <option value="" selected>Nessuno</option>
                                        @foreach ($trainers as $trainer)
                                            <option @if ($group->secondo_allenatore_id == $trainer->id) selected @endif
                                                value="{{ $trainer->id }}">
                                                {{ $trainer->name }} {{ $trainer->cognome }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="custom-form-input" id="condiviso" name="condiviso" required>
                                        <option @if ($group->condiviso == 'true') selected @endif value="true">Sì
                                        </option>
                                        <option @if ($group->condiviso == 'false') selected @endif value="false">No
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="custom-form-input" id="numero_massimo_partecipanti"
                                        ...
                                        <option @if ($group->numero_massimo_partecipanti == '8') selected @endif value="8">8
                                        </option>
                                        <option @if ($group->numero_massimo_partecipanti == '10') selected @endif value="10">10
                                        </option>
                                        <option @if ($group->numero_massimo_partecipanti == '16') selected @endif value="16">16
                                        </option>
                                    </select>
                                </div>
                                {{-- LIVELLO --}}
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $group->livello }}" type="number" class="custom-form-input"
                                        id="livello" name="livello" required min="1" max="12">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3 d-flex flex-column align-items-center">
                                    <button type="submit" class="custom-btn-submit">Modifica Gruppo</button>
                                    <a class="btn admin-btn-info mt-3"
                                        href="{{ route('admin.group.details', $group) }}">Indietro</a>
                                </div>
                            </div>
                        </div>
                    </div>
