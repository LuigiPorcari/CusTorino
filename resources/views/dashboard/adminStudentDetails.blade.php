                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input placeholder="@if ($student->livello == null) N.C. @endif"
                                                value="{{ $student->livello }}" type="number" class="form-control"
                                                name="level" min="1" max="12">
                                        </div>
                                        <!-- Campo per Genere -->
                                        <div class="mb-3">
                                            ...
                                            @if ($student->genere != 'Misto')
                                                <select class="form-control" name="genere">
                                                    <option @if ($student->genere == 'M') selected @endif
                                                        value="M">
                                                        Maschio
                                                    </option>
                                                    <option @if ($student->genere == 'F') selected @endif
                                                        value="F">
                                                        Femmina
                                                    </option>
                                                    <option @if ($student->genere == 'misto') selected @endif
                                                        value="misto">
                                                        Misto
                                                    </option>
                                                </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="cus_card">
                                                <option @if ($student->cus_card == 1) selected @endif
                                                    value="1">OK
                                                </option>
                                                <option @if ($student->cus_card == 0) selected @endif
                                                    value="0">NON OK
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="visita_medica">
                                                <option @if ($student->visita_medica == 1) selected @endif
                                                    value="1">OK
                                                </option>
                                                <option @if ($student->visita_medica == 0) selected @endif
                                                    value="0">NON OK
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="pagamento">
                                                <option @if ($student->pagamento == 1) selected @endif
                                                    value="1">OK
                                                </option>
                                                <option @if ($student->pagamento == 0) selected @endif
                                                    value="0">NON OK
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="trimestrale">
                                                <option @if ($student->trimestrale == 1) selected @endif
                                                    value="1">Si
                                                </option>
                                                <option @if ($student->trimestrale == 0) selected @endif
                                                    value="0">No
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="universitario">
                                                <option @if ($student->universitario == 1) selected @endif
                                                    value="1">SI
                                                </option>
                                                <option @if ($student->universitario == 0) selected @endif
                                                    value="0">NO
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label"><strong>Questo Corsista è anche
                                                    Allenatore?</strong></label>
                                            <select class="form-control" name="is_trainer">
                                                <option @if ($student->is_trainer == 1) selected @endif
                                                    value="1">SI
                                                </option>
                                                <option @if ($student->is_trainer == 0) selected @endif
                                                    value="0">NO
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ $student->Nrecuperi }}" type="number"
                                                class="form-control" name="Nrecuperi" min="0">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3 d-flex justify-content-center">
                                            ...
                                            <button type="button" class="btn admin-btn-danger ms-1"
                                                ...
                                                data-bs-target="#deleteModal{{ $student->id }}">Elimina
                                                Corsista</button>
                                        </div>
                                    </div>
                                </div>
